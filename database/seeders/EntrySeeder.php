  ...
  public function run() {
    $testData = [
      [
        ...
        'date_finished' => Carbon::parse('01-01-2015')->format('Y-m-d'),
        ...
        'date_finished' => Carbon::parse('02-01-2015')->format('Y-m-d'),
        ...
        'date_finished' => Carbon::parse('03-01-2015')->format('Y-m-d'),
        ...
        'id_quality' => 2,
        'title' => "2title 6",
        'date_finished' => Carbon::parse('04-01-2015')->format('Y-m-d'),
