            ...
            new OA\Schema(
              properties: [
                new OA\Property(
                  property: 'data',
                  properties: [
                    new OA\Property(property: 'owners', ref: '#/components/schemas/DefaultImportSchema'),
                    new OA\Property(property: 'components', ref: '#/components/schemas/DefaultImportSchema'),
                    new OA\Property(property: 'infos', ref: '#/components/schemas/DefaultImportSchema'),
                    new OA\Property(property: 'setups', ref: '#/components/schemas/DefaultImportSchema'),
                  ]
                ),
              ]
            ),
