...
class BucketSimController extends Controller {
            ...
            new OA\Schema(
              properties: [
                new OA\Property(
                  property: 'data',
                  type: 'array',
                  items: new OA\Items(ref: '#/components/schemas/BucketSimInfo')
                ),
              ]
            ),
          ]
          ...
          allOf: [
            ...
            new OA\Schema(
              properties: [
                ...
                new OA\Property(property: 'stats', ref: '#/components/schemas/BucketSimInfo'),
              ]
            ),
          ]
        )
  ...
  #[OA\Post(
    ...
    security: [['token' => [], 'api-key' => []]],
    parameters: [
      new OA\Parameter(ref: '#/components/parameters/bucket_sim_add_edit_description'),
      new OA\Parameter(ref: '#/components/parameters/bucket_sim_add_edit_buckets'),
    ],
    responses: [
