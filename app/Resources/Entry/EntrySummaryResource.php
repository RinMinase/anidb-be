...
#[OA\Schema(
  properties: [
    ...
    new OA\Property(property: "rewatchCount", type: "integer", format: "int32", example: 1),
    ...
    new OA\Property(property: "encoder", type: "string", example: "encoder—encoder2"),
    new OA\Property(property: "release", type: "string", example: "Spring 2017"),
    new OA\Property(property: "remarks", type: "string", example: "Some remarks"),
    new OA\Property(property: "rating", type: "number", example: 7.5),
    new OA\Property(property: "ratingOver5", type: "number", example: 3.75),
    new OA\Property(
      property: "genres",
      type: "array",
